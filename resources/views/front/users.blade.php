            ...
            <div class="search-filter mb-30">
                <form action="{{route('front.user.view')}}">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-3">
                            <div class="search-box">
                                <input type="text" class="form_control" placeholder="{{__('Search by keywords')}}" name="keywords" value="{{request()->input('keywords')}}">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="search-box">
                ...
                @foreach($users as $user)
                    <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="user-item mb-40">
                            <div class="title">
                                @if(isset($user->photo))
                                    <img class="lazy" data-src="{{asset('assets/user/img/'.$user->photo)}}" alt="">
                                @else
