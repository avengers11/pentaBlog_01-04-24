                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="order_wrap_box mb-40">
                            ...
                            <div class="dis-none gateway-details" id="tab-stripe">
                                <div class="row py-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form_group">
                                            <label>{{__('Year')}} *</label>
                                            <input type="text" class="form_control" placeholder="{{__('Year')}}" name="year"
                                                   disabled>
                                            @if($errors->has('year'))
                            ...
                            <div class="text-center">
                                <button form="my-checkout-form" class="main-btn mt-4 w-100" type="submit">{{__('Confirm')}}
                                </button>
                            </div>
                        </div>
                    </div>
