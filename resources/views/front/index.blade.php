...
@section('content')
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-5">
                        <div class="choose-content-box mb-40">
                            <div class="section-title-one mb-20">
    ...
    @if ($bs->featured_users_section == 1)
        ...
        <section class="saas-featured-users pt-80 pb-120">
            <div class="container">
                <div class="row justify-content-center text-center">
                    <div class="col-lg-6">
                ...
                <div class="user-slide">
                    @foreach($featured_users as $featured_user)
                        <div class="user-item">
                            <div class="title">
                                <img class="lazy" data-src="{{ isset($featured_user->photo) ? asset('assets/user/img/'.$featured_user->photo) : asset('assets/admin/img/propics/blank_user.jpg')}}" alt="user">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-sm-12">
                                        <div class="pricing-item">
                                            ...
                                            <div class="pricing-body">
                                                <ul class="list">
                                                    <li class="checked">{{$package->post_categories_limit === 999999 ? __('Unlimited') : $package->post_categories_limit }}
                                                        {{__('Post Categories')}}
                                                    </li>
                                                    <li class="checked">{{$package->posts_limit === 999999 ? __('Unlimited') : $package->posts_limit}} {{__('Posts')}}</li>
                                                    <li class="checked">{{$package->feature_posts_limit === 999999 ? __('Unlimited') : $package->feature_posts_limit}} {{__('Featured Posts')}}</li>
                                                    <li class="checked">{{$package->language_limit === 999999 ? __('Unlimited') : $package->language_limit}} {{__('Languages')}}</li>
