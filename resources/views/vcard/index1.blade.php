...
@if ($vcard->direction == 2)
@section('rtl-css')
<link rel="stylesheet" href="{{asset('assets/user/vcard/vcard-rtl.css')}}">
@endsection
@endif

@section('base-color')
<link rel="stylesheet" href="{{asset('assets/user/vcard/vcard-base-color.php').'?color='.$vcard->base_color}}">
@endsection

@section('og-image', asset('assets/user/img/vcard/' . $vcard->cover_image))
@section('og-title')
    ...
    <div class="page-wrapper">
        <div class="container p-0">
            <div class="page-content page-content-three">
                <div class="page-banner bg_cover" style="background-image: url({{!empty($vcard->cover_image) ? asset('assets/user/img/vcard/' . $vcard->cover_image) : asset('assets/user/img/vcard/vcard_cover.jpg')}});"></div>
                <div class="admin-wrapper">
                    <div class="admin-card text-center">
                        <div class="thumb">
                            <img src="{{!empty($vcard->profile_image) ? asset('assets/user/img/vcard/' . $vcard->profile_image) : asset('assets/user/img/blank_propic.png')}}" alt="Picture">
                        </div>
                        <div class="content">
                    ...
                    @foreach ($services as $service)
                        <div class="service-item mb-3">
                            <div class="service-img">
                                <img class="w-100 lazy" data-src="{{asset('assets/user/img/services/' . $service->image)}}" alt="service img">
                            </div>
                            <div class="content">
                                <h4>{{$service->title}}</h4>
                    ...
                    <div class="portfolio-slider-one">
                        ...
                        <div class="portfolio-item">
                            <div class="portfolio-img">
                                <img data-src="{{asset('assets/user/img/projects/' . $project->image)}}" alt="portfolio" class="w-100 lazy">
                                <a href="{{asset('assets/user/img/projects/' . $project->image)}}" class="portfolio-overlay img-popup">
                                    <div class="info">
                    ...
                    <div class="testimonial-slider-one">
                        ...
                        <div class="testimonial-item">
                            <div class="title-thumb d-flex align-items-center">
                                <div class="thumb">
                                    <img class="lazy" data-src="{{asset('assets/user/img/testimonials/' . $testimonial->image)}}" alt="thumb">
                                </div>
                                <div class="title">
