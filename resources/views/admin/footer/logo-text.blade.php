            ...
            <div class="col-lg-6 offset-lg-3">
              ...
              <form id="ajaxForm" action="{{route('admin.footer.update', $lang_id)}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <textarea id="copyright_text" name="copyright_text" class="summernote form-control" data-height="100">
                      @if(!empty($abs->copyright_text))
                          {!! replaceBaseUrl($abs->copyright_text) !!}
                      @endif
                  </textarea>
