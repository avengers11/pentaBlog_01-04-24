            ...
            <form id="textsForm" action="{{route('admin.custom-domain.texts')}}" method="POST">
              @csrf
                ...
                <div class="form-group">
                    ...
                    <textarea class="summernote" name="cname_record_section_text" data-height="150" class="form-control">
                        @if(!empty($abe->cname_record_section_text))
                           {!! replaceBaseUrl($abe->cname_record_section_text) !!}
                        @endif
                    </textarea>
