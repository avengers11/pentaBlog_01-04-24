                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 offset-lg-2 mt-2 mt-lg-0">
                        ...
                        <form action="{{request()->url()}}" class="float-right d-flex">
                            ...
                            @endif
                            <input name="username" class="form-control mr-2 min-w-250" type="text" placeholder="{{__('Search by Username')}}" value="{{request()->input('username')}}">
                            <input name="domain" class="form-control min-w-250" type="text" placeholder="{{__('Search by Domain')}}" value="{{request()->input('domain')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form id="statusForm{{$rcDomain->id}}" action="{{route('admin.custom-domain.status')}}" method="POST">
                                                ...
                                                <select class="form-control form-control-sm max-w130
