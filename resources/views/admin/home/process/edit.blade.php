            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" name="title" placeholder="{{__('Enter title')}}" value="{{$process->title}}">
                    @if ($errors->has('title'))
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control ltr" name="serial_number" value="{{$process->serial_number}}" placeholder="{{__('Enter Serial Number')}}">
