                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-3">
                        ...
                        <form id="ajaxForm" class="modal-form" action="{{route('admin.popup.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{$popup->name}}" placeholder="{{__('Enter Name')}}">
                                        <p class="text-warning mb-0">{{__('This will not be shown in the popup in Website, it will help you to identify the popup in Admin Panel.')}}</p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control ltr" name="background_opacity" value="{{$popup->background_opacity}}" placeholder="{{__('Enter Opacity Value')}}">
                            ...
                            <div class="form-group">
                                <label for="">{{__('Delay (milliseconds)')}} **</label>
                                <input type="number" class="form-control ltr" name="delay" value="{{$popup->delay}}" placeholder="{{__('Enter Milliseconds')}}">
