            ...
            <div class="row">
              <div class="col-lg-6 offset-lg-3">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control" name="contact_form_title" value="{{$abs->contact_form_title}}" placeholder="{{__('Enter form Title')}}">
                ...
                <div class="form-group">
                  ...
                  <div class="text-warning">{{__('Use newline to separate multiple addresses')}}</div>
