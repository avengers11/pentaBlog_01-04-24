...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['vCard_Management'] ?? __('vCard Management') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['vCard_Management'] ?? __('vCard Management') }}</a>
            </li>
            <li class="separator">
                <i class="flaticon-right-arrow"></i>
            </li>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete"
                        data-href="{{ route('user.vcard.bulk.delete') }}"><i
                                                        ...
                                                        <div class="dropdown show d-inline-block mr-2">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.edit', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Information'] ?? __('Information') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.color', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Colors'] ?? __('Colors') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.preferences', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Preferences'] ?? __('Preferences') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.services', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Services'] ?? __('Services') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.projects', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Projects'] ?? __('Projects') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.testimonials', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Testimonials'] ?? __('Testimonials') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.about', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['About_and_Video'] ?? __('About & Video') }}</a>
                                                                <a target="_blank" class="dropdown-item"
                                                                    href="{{ route('user.vcard.keywords', [$vcard->id, 'language' => request('language')]) }}">{{ $keywords['Translate_Keywords'] ?? __('Translate Keywords') }}</a>
                                                            </div>
                                                        </div>
