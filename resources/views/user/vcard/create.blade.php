        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-info btn-sm float-right d-inline-block" href="{{ route('user.vcard', ['language' => request('language')]) }}">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <p class="text-warning">
                                                {{ $keywords['Image_size_can_be_maximum_200_KB'] ?? __('Image size can be maximum 200 KB') }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
...
@endsection
@section('scripts')
    <script src="{{ asset('assets/user/vcard/create-vcard.js') }}"></script>
@endsection
