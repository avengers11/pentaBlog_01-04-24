...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form
                    action="{{ route('user.advertisement.update_settings', ['language' => request()->input('language')]) }}"
                    method="post">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                <div class="form-group">
                                    ...
                                    <p>
                                        <a target="_blank" href="//prnt.sc/1uvqtdw">{{ $keywords['Click_here'] ?? __('Click here') }}</a>
