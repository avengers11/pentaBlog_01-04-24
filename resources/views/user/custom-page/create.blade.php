...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Add_Page'] ?? __('Add Page') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['Add_Page'] ?? __('Add Page') }}</a>
            </li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">{{ $keywords['Add_Page'] ?? __('Add Page') }}</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label
                                                for="">{{ $keywords['Page_Status'] ?? __('Page Status') }}*</label>
                                            <select name="status" class="form-control">
                                                <option selected disabled>{{ $keywords['Select_a_Status'] ?? __('Select a Status') }}</option>
                                                <option value="1">{{ $keywords['Active'] ?? __('Active') }}</option>
                                                <option value="0">{{ $keywords['Deactive'] ?? __('Deactive') }}
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div
                                                                ...
                                                                <textarea class="form-control summernote" name="{{ $language->code }}_content"
                                                                    placeholder="{{ $keywords['Enter_Content'] ?? __('Enter Content') }}" data-height="300"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div
                                                                ...
                                                                <textarea class="form-control" name="{{ $language->code }}_meta_description" rows="5"
                                                                    placeholder="{{ $keywords['Enter_Meta_Description'] ?? __('Enter Meta Description') }}"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
