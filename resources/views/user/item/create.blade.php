...
@section('content')
    ...
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Add_Item'] ?? __('Add Item') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['Add_Item'] ?? __('Add Item') }}</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">{{ $keywords['Add_Item'] ?? __('Add Item') }}</div>
                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="itemForm" class="" action="{{ route('user.item.store') }}" method="post"
                                ...
                                @if ($type == 'physical')
                                    <div class="form-group">
                                        <label for="">{{ $keywords['Stock_Item'] ?? __('Stock Item') }} **</label>
                                        <input type="number" id="productStock" class="form-control ltr" name="stock"
                                            value=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="file_type" class="form-control" id="fileType">
                                            <option value="upload" selected>
                                                {{ $keywords['File_Upload'] ?? __('File Upload') }}</option>
                                            <option value="link">
                                                {{ $keywords['File_Download_Link'] ?? __('File Download Link') }}</option>
                                        </select>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control ltr" name="status">
                                                ...
                                                <option value="1">{{ $keywords['Show'] ?? __('Show') }}</option>
                                                <option value="0">{{ $keywords['Hide'] ?? __('Hide') }}</option>
                                            </select>
                                                ...
                                                <div class="version-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div
                                                                ...
                                                                <label>{{ $keywords['Select_Category'] ?? __('Select Category') }}*</label>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div
                                                                class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                                                <label>{{ $keywords['Summary'] ?? __('Summary') }}</label>
                                                                <textarea class="form-control" name="{{ $language->code }}_summary"
                                                                    placeholder="{{ $keywords['Enter_Summary'] ?? __('Enter Summary') }}"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div
                                                                ...
                                                                <textarea class="form-control" name="{{ $language->code }}_meta_keyword" rows="5"
                                                                    placeholder="{{ $keywords['Enter_Meta_keyword'] ?? __('Enter Meta keyword') }}"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
