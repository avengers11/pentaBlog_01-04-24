...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Add_Testimonial'] ?? __('Add Testimonial') }}</h4>
        <ul class="breadcrumbs">
            ...
            <li class="nav-item">
                <a href="#">{{ $keywords['Add_Testimonial'] ?? __('Add Testimonial') }}</a>
            </li>
        </ul>
    </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <div class="card-title d-inline-block">{{ $keywords['Add_Testimonial'] ?? __('Add Testimonial') }}</div>
                ...
                <div class="card-body py-5">
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="testimonialForm" action="{{ route('user.about_me.store_testimonial') }}"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <div class="col-12 mb-2">
                                                <label for="image"><strong>{{ $keywords['Clients_Image'] ?? __('Client\'s Image') }}
                                                        *</strong></label>
                                            </div>
                                            ...
                                            <input type="file" name="client_image" id="image" class="form-control">
                                            <p class="text-warning mb-0 mt-2">
                                                {{ $keywords['img_validation_msg'] ?? __('** Only JPG, PNG, JPEG, SVG Images are allowed') }}
                                            </p>
                                            <p id="errclient_image" class="mb-0 text-danger em"></p>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <div class="version-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <div
                                                                class="form-group {{ $language->rtl == 1 ? 'rtl text-right' : '' }}">
                                                                <label>{{ $keywords['Clients_Comment'] ?? __('Client\'s Comment') }}
                                                                    *</label>
                                                                <textarea class="form-control" name="{{ $language->code }}_comment"
                                                                    placeholder="{{ $keywords['Enter_Client_Comment'] ?? __('Enter Client Comment') }}" rows="5"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
