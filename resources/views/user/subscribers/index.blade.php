...
@section('content')
    <div class="page-header">
        <h4 class="page-title">{{ $keywords['Subscribers'] ?? __('Subscribers') }}</h4>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-6">
                            <div class="card-title d-inline-block">{{ $keywords['Subscribers'] ?? __('Subscribers') }}</div>
                        </div>
                        <div class="col-6 mt-2 mt-lg-0">
                            ...
                            <form action="{{ url()->full() }}" class="float-right">
                                <input type="text" name="term" class="form-control"
                                    ...
                                    placeholder="{{ $keywords['Search_by_Email'] ?? __('Search by Email') }}">
                            </form>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (count($subscs) == 0)
                                <h3 class="text-center">{{ $keywords['NO_SUBSCRIBER_FOUND'] ?? __('NO SUBSCRIBER FOUND') }}</h3>
                            @else
