<header class="header-area header-area_v1 {{ !request()->routeIs('index') ? 'header-static' : '' }}">
    <!-- Start mobile menu -->
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="more-option mobile-item">
                    <div class="item">
                        <a href="#searchBox" class="btn-search btn-icon-only" target="_self" aria-label="Search Form"
