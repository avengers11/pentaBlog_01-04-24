  ...
  @foreach ($popupInfos as $popupInfo)
    ...
    @if ($type == 1)
      <div data-popup_delay="{{ $popupInfo->delay }}" data-popup_id="{{ $popupInfo->id }}" id="modal-popup{{ $popupInfo->id }}" class="popup-wrapper">
        <div>
          <img data-src="{{ asset('assets/user/img/popups/' . $popupInfo->image) }}" class="lazy" alt="Popup Image" width="100%">
        </div>
      </div>
    @elseif ($type == 2)
      <div data-popup_delay="{{ $popupInfo->delay }}" data-popup_id="{{ $popupInfo->id }}" id="modal-popup{{ $popupInfo->id }}" class="popup-wrapper">
        <div class="popup-one bg_cover lazy" data-bg="{{ asset('assets/user/img/popups/' . $popupInfo->image) }}">
    ...
    @elseif ($type == 3)
      <div data-popup_delay="{{ $popupInfo->delay }}" data-popup_id="{{ $popupInfo->id }}" id="modal-popup{{ $popupInfo->id }}" class="popup-wrapper">
        <div class="popup-two bg_cover lazy" data-bg="{{ asset('assets/user/img/popups/' . $popupInfo->image) }}">
          <div class="popup_main-content" style="background-color: {{ '#' . $popupInfo->background_color }}; opacity: {{ $popupInfo->background_color_opacity }};">
            <h1>{{ $popupInfo->title }}</h1>
            <p>{{ $popupInfo->text }}</p>
      ...
      <div data-popup_delay="{{ $popupInfo->delay }}" data-popup_id="{{ $popupInfo->id }}" id="modal-popup{{ $popupInfo->id }}" class="popup-wrapper">
        <div class="popup-three">
          <div class="popup_main-content">
            <div class="left-bg bg_cover lazy" data-bg="{{ asset('assets/user/img/popups/' . $popupInfo->image) }}"></div>
    ...
    @elseif ($type == 6)
      <div data-popup_delay="{{ $popupInfo->delay }}" data-popup_id="{{ $popupInfo->id }}" id="modal-popup{{ $popupInfo->id }}" class="popup-wrapper">
        <div class="popup-five bg_cover lazy" data-bg="{{ asset('assets/user/img/popups/' . $popupInfo->image) }}">
          <div class="popup_main-content">
            <h1>{{ $popupInfo->title }}</h1>
      ...
      <div data-popup_delay="{{ $popupInfo->delay }}" data-popup_id="{{ $popupInfo->id }}" id="modal-popup{{ $popupInfo->id }}" class="popup-wrapper">
        <div class="popup-six">
          <div class="popup_main-content">
            ...
            <div class="right-content bg_cover" style="background-color: {{ '#' . $popupInfo->background_color }}; background-image: url({{ asset('assets/user/img/popups/right-bg.png') }});">
              <h1>{{ $popupInfo->title }}</h1>
              <h4>{{ $popupInfo->text }}</h4>
