        ...
        <div class="header">
            ...
            <div class="order-details">
                <table class="text-right">
                    ...
                    <tr>
                        <td class="gry-color small"><strong>{{__('Order Price')}}:</strong> {{$amount == 0 ? __('Free'): $amount}}</td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>{{__('Payment Method')}}:</strong> {{$request['payment_method']}}</td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>{{__('Payment Status')}}:</strong>{{__('Completed')}}</td>
                    </tr>
                    <tr>
                        <td class="gry-color small"><strong>{{__('Order Date')}}:</strong> {{\Illuminate\Support\Carbon::now()->format('d/m/Y')}}</td>
                    </tr>
                </table>
            </div>
        </div>
