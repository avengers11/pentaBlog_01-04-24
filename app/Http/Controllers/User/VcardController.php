...
class VcardController extends Controller
{
    ...
    public function serviceStore(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $directory = public_path('assets/user/img/services/');
    ...
    public function serviceUpdate(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $filename = time() . '.' . $img->getClientOriginalExtension();
            $request->file('image')->move(public_path('assets/user/img/services/'), $filename);
            if (file_exists(public_path('assets/user/img/services/' . $service->image))) {
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('profile_image')) {
            ...
            $dir = public_path('assets/user/img/vcard/');
            @mkdir($dir, 0775, true);
    ...
    public function projectStore(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $filename = time() . '.' . $img->getClientOriginalExtension();
            $directory = public_path('assets/user/img/projects/');
    ...
    public function projectUpdate(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $filename = time() . '.' . $img->getClientOriginalExtension();
            $request->file('image')->move(public_path('assets/user/img/projects/'), $filename);
    ...
    public function testimonialUpdate(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            $filename = time() . '.' . $img->getClientOriginalExtension();
            $request->file('image')->move(public_path('assets/user/img/testimonials/'), $filename);
            if (file_exists(public_path('assets/user/img/testimonials/' . $testimonial->image))) {
