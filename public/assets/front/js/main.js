...
$(document).ready(function () {
    $(document).on('click', '.more-feature', function () {
        var $packId = $(this).attr('data-id');
        if ($('#' + $packId).find('.show-more').text() == 'Show More') {
            $('#' + $packId).find('.extra').css({
                'height': 'auto',
            })
            $('#' + $packId).find('.show-more').text('Show Less')
        } else {
            $('#' + $packId).find('.extra').css({
                'height': '420px'
            })
            $('#' + $packId).find('.show-more').text('Show More')
        }
        $('#' + $packId).find('.fa-angle-down').toggleClass('fa-angle-up')
    })
})
