...
!function (e) {
    e(["jquery"], function (e) {
        return function () {
            var n, t, o = 0, i = {error: "error", info: "info", success: "success", warning: "warning"}, s = {
                clear: function (t) {
                    var o = c();
                    n || d(o);
                    if (t && 0 === e(":focus", t).length) return void t[o.hideMethod]({
                    ...
                    n.children().length && n[o.hideMethod]({
                        duration: o.hideDuration,
                        easing: o.hideEasing,
                        complete: function () {
                            n.remove()
                ...
                }, getContainer: d, info: function (e, n, t) {
                    return r({
                        type: i.info,
                ...
                }, version: "2.0.1", warning: function (e, n, t) {
                    return r({
                        type: i.warning,
            ...
            function r(t) {
                var i = c(), s = t.iconClass || i.iconClass;
                void 0 !== t.optionsOverride && (i = e.extend(i, t.optionsOverride), s = t.optionsOverride.iconClass || s), o++, n = d(i);
                var r = null, l = e("<div/>"), p = e("<div/>"), f = e("<div/>"), g = e(i.closeHtml),
                    h = {toastId: o, state: "visible", startTime: new Date, options: i, map: t};
                return t.iconClass && l.addClass(i.toastClass).addClass(s), t.title && (p.append(t.title).addClass(i.titleClass), l.append(p)), t.message && (f.append(t.message).addClass(i.messageClass), l.append(f)), i.closeButton && (g.addClass("toast-close-button"), l.prepend(g)), l.hide(), i.newestOnTop ? n.prepend(l) : n.append(l), l[i.showMethod]({
                    duration: i.showDuration,
                    easing: i.showEasing,
                    complete: i.onShown
                }), i.timeOut > 0 && (r = setTimeout(m, i.timeOut)), l.on('hover', function () {
                    clearTimeout(r), l.stop(!0, !0)[i.showMethod]({duration: i.showDuration, easing: i.showEasing})
                }, function () {
                    (i.timeOut > 0 || i.extendedTimeOut > 0) && (r = setTimeout(m, i.extendedTimeOut))
                }), !i.onclick && i.tapToDismiss && l.click(m), i.closeButton && g && g.on('click', function (e) {
                    e.stopPropagation(), m(!0)
                }), i.onclick && l.on('click', function () {
                    i.onclick(), m()
                }), a(h), i.debug && console && console.log(h), l;

                function m(n) {
                    if (!e(":focus", l).length || n) return l[i.hideMethod]({
                        duration: i.hideDuration,
                        easing: i.hideEasing,
                        complete: function () {
                            u(l), i.onHidden && i.onHidden(), h.state = "hidden", h.endTime = new Date, a(h)
                        }
                    })
                }
            }
            ...
            function d(t) {
                return t || (t = c()), (n = e("#" + t.containerId)).length ? n : ((n = e("<div/>").attr("id", t.containerId).addClass(t.positionClass)).appendTo(e(t.target)), n)
            }
            ...
            function u(e) {
                n || (n = d()), e.is(":visible") || (e.remove(), e = null, 0 === n.children().length && n.remove())
            }
        }()
    })
}("function" == typeof define && define.amd ? define : function (e, n) {
    "undefined" != typeof module && module.exports ? module.exports = n(require(e[0])) : window.toastr = n(window.jQuery)
});
...
!function (v) {
    v.fn.floatingWhatsApp = function (e) {
        ...
        function C() {
            var e = "http://";
            e += o ? "api" : "web", e += ".whatsapp.com/send?phone=" + i.phone + "&text=" + window.encodeURIComponent(i.message), window.open(e)
        }
...
!function (t, n) {
    ...
    var n = "undefined" != typeof window,
        ...
        r = n && window.devicePixelRatio > 1, a = {
        ...
        }, l = "loading", u = "loaded", d = "applied", f = "error", _ = "native", g = function (t, n) {
            return t.getAttribute("data-" + n)
        }, v = function (t) {
            return g(t, "ll-status")
        }, p = function (t, n) {
            ...
            z(t, "sizes", g(t, n.data_sizes)), z(t, "srcset", g(t, n.data_srcset)), z(t, "src", g(t, n.data_src))
        }, T = function (t) {
            C(t, "src"), C(t, "srcset"), C(t, "sizes")
        }, j = function (t, n) {
            var e = t.parentNode;
            e && "PICTURE" === e.tagName && x(e).forEach(n)
        }, D = {
            IMG: function (t, n) {
                j(t, function (t) {
                    M(t), G(t, n)
                ...
                }(t), z(t, "poster", g(t, n.data_poster)), z(t, "src", g(t, n.data_src)), t.load()
            }
        }, F = function (t, n) {
            var e = D[t.tagName];
            e && e(t, n)
        }, P = function (t, n, e) {
            k(e, 1), A(t, n.class_loading), p(t, l), y(n.callback_loading, t, e)
        }, S = ["IMG", "IFRAME", "VIDEO"], V = function (t, n) {
            !n || n.loadingCount > 0 || n.toLoadCount > 0 || y(t.callback_finish, n)
        }, U = function (t, n, e) {
            ...
            }(t), k(e, -1), e && (e.toLoadCount -= 1), I(t, n.class_loading), n.unobserve_completed && w(t, e)
        }, J = function (t, n, e) {
            var i = L(t) || t;
            q(i) || function (t, n, e) {
                q(t) || (t.llEvLisnrs = {});
                ...
                !function (t, n, e, i) {
                    var o = m(n);
                    B(n, e, i), A(n, e.class_loaded), p(n, u), y(e.callback_loaded, n, i), o || V(e, i)
                }(0, t, n, e), H(i)
            }, function (o) {
                !function (t, n, e, i) {
                    var o = m(n);
                    B(n, e, i), A(n, e.class_error), p(n, f), y(e.callback_error, n, i), o || V(e, i)
                }(0, t, n, e), H(i)
            })
        }, K = function (t, n, e) {
            !function (t) {
                ...
                !function (t) {
                    ...
                    var i = g(t, n.data_bg), o = g(t, n.data_bg_hidpi), a = r && o ? o : i;
                    a && (t.style.backgroundImage = 'url("'.concat(a, '")'), L(t).setAttribute("src", a), P(t, n, e))
                }(t, n, e), function (t, n, e) {
                    var i = g(t, n.data_bg_multi), o = g(t, n.data_bg_multi_hidpi), a = r && o ? o : i;
                    a && (t.style.backgroundImage = a, function (t, n, e) {
                        A(t, n.class_applied), p(t, d), n.unobserve_completed && w(t, n), y(n.callback_applied, t, e)
                    }(t, n, e))
                }(t, n, e)
            }(t, n, e) : function (t, n, e) {
                J(t, n, e), F(t, n), P(t, n, e)
            }(t, n, e)
        }, Q = ["IMG", "IFRAME"], W = function (t) {
            ...
            this._settings = o, this.loadingCount = 0, function (t, n) {
                    ...
                    !function (t, n, e) {
                        t.forEach(function (t) {
                            return function (t) {
                                ...
                                p(t, "entered"), A(t, e.class_entered), I(t, e.class_exited), function (t, n, e) {
                                    n.unobserve_entered && w(t, e)
                                }(t, e, i), y(e.callback_enter, t, n, i), function (t) {
                                    return E.indexOf(v(t)) >= 0
                                }(t) || K(t, e, i)
                            }(t.target, t, n, e) : function (t, n, e, i) {
                                h(t) || (A(t, e.class_exited), function (t, n, e, i) {
                                    ...
                                    }(t), I(t, e.class_loading), k(i, -1), b(t), y(e.callback_cancel, t, n, i))
                                }(t, n, e, i), y(e.callback_exit, t, n, i))
                            }(t.target, t, n, e)
                        })
                    }(e, t, n)
                }, function (t) {
                ...
                n && window.addEventListener("online", function () {
                    !function (t, n) {
                        var e;
                        (e = Y(t), X(e).filter(Z)).forEach(function (n) {
                            I(n, t.class_error), b(n)
                        }), n.update()
                    }(t, e)
                })
    ...
    return nt.prototype = {
        update: function (t) {
            var n, o, r = this._settings, a = tt(t, r);
            O(this, a.length), !e && i ? W(r) ? function (t, n, e) {
                a.forEach(function (t) {
                    -1 !== Q.indexOf(t.tagName) && (t.setAttribute("loading", "lazy"), function (t, n, e) {
                        J(t, n, e), F(t, n), p(t, _)
                    }(t, n, e))
                }), O(e, 0)
            }(0, r, this) : (o = a, function (t) {
                t.disconnect()
            ...
            this._observer && this._observer.disconnect(), Y(this._settings).forEach(function (t) {
                delete t.llOriginalAttrs
            }), delete this._observer, delete this._settings, delete this.loadingCount, delete this.toLoadCount
        }, loadAll: function (t) {
            var n = this, e = this._settings;
            tt(t, e).forEach(function (t) {
                w(t, n), K(t, e, n)
            })
        }
